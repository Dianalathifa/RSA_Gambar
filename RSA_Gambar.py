...
def encrypt_image(image_path):
    ...
    cv2.imwrite("chiki_enkripsi.jpg", encrypted_img)  # Menyimpan gambar terenkripsi
...
def decrypt_image(encrypted_data, key, height, width):
    ...
    cv2.imwrite("chiki_dekripsi.jpg", decrypted_img)  # Menyimpan gambar terdekripsi
...
image_path = "chiki.jpeg"  # Ganti dengan path gambar yang ingin dienkripsi
